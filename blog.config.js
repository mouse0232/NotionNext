...
const BLOG = {
  ...
  DIFY_CHATBOT_BASE_URL: process.env.NEXT_PUBLIC_DIFY_CHATBOT_BASE_URL || 'https://api.dify.ai/v1',
  DIFY_CHATBOT_TOKEN: process.env.NEXT_PUBLIC_DIFY_CHATBOT_TOKEN || 'app-E6J45mXuzjJJm9ajEoUrCxiv',
  // 悬浮挂件
